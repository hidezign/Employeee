    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div className="mb-8">
            <h1 className="text-4xl tracking-tighter font-black mb-2" data-testid="login-page-title">
              EMPLOYEE SYSTEM
            </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4" data-testid="login-form">
            ...
            {error && (
              <div className="p-3 bg-red-50 border border-red-200" data-testid="login-error-message">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-zinc-500">
              ...
              <Link to="/register" className="font-bold text-zinc-950 hover:underline" data-testid="login-register-link">
                Register
              </Link>
            </p>
          </div>
